...
import cn.com.flaginfo.platform.export.model.excel.policy.PlatformDailyIncomePolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class PlatformDailyIncomeTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new PlatformDailyIncomePolicy(this);
		//设置导出writer

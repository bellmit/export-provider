...
import cn.com.flaginfo.platform.export.model.excel.policy.TemplateListPolicy;

public class TemplateListTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new TemplateListPolicy(this);
		//设置导出writer

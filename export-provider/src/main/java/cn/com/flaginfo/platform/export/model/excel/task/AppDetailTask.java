...
import cn.com.flaginfo.platform.export.model.excel.policy.AppDetailPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class AppDetailTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new AppDetailPolicy(this);
		//设置导出writer

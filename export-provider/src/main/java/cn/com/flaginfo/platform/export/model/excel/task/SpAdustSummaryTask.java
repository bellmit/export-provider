...
import cn.com.flaginfo.platform.export.model.excel.policy.SpAdustSummaryPolicy;

public class SpAdustSummaryTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SpAdustSummaryPolicy(this);
		//设置导出writer

...
import cn.com.flaginfo.platform.export.model.excel.policy.CmcTaskListPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class CmcTaskListTask extends ExportTask {
	...
	public void execute() {
		...
		//设置导出策略
		Policy policy = new CmcTaskListPolicy(this);
		//设置导出writer

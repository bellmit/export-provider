...
import cn.com.flaginfo.platform.export.model.excel.policy.GoodsBuyRecordPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class GoodsBuyRecordTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new GoodsBuyRecordPolicy(this);
		//设置导出writer

...
import cn.com.flaginfo.platform.export.model.excel.policy.SmsBillByProductPolicy;

public class SmsBillByProductTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SmsBillByProductPolicy(this);
		//设置导出writer

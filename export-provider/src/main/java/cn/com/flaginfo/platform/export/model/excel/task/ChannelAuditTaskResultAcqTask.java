...
import cn.com.flaginfo.platform.export.model.excel.policy.ChannelAuditTaskResultAcqPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class ChannelAuditTaskResultAcqTask extends ExportTask {
	...
	public void execute() {
		...
		//设置导出策略
		Policy policy = new ChannelAuditTaskResultAcqPolicy(this);
		//设置导出writer

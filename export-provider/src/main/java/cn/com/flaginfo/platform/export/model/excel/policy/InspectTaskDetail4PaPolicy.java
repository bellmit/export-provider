...
public class InspectTaskDetail4PaPolicy extends Policy {
	...
	public InspectTaskDetail4PaPolicy(ExportTask task){
		this.task = task;
		initPolicy();
	}
	...
	public void initPolicy() {
		...
		titles = new String[]{ "任务编号", "企业编号", "手机号", "姓名", "身份证号","查询状态","查询结果", "成本","查询时间"};
		keys = new String[]{"taskId", "spCode", "mdn", "name", "idNo", "status","code", "cost","createTime"};

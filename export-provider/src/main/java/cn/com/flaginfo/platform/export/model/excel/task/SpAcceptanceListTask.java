...
import cn.com.flaginfo.platform.export.model.excel.policy.SpAcceptanceListPolicy;

public class SpAcceptanceListTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SpAcceptanceListPolicy(this);
		//设置导出writer

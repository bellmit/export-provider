...
import cn.com.flaginfo.platform.export.model.excel.policy.InspectTaskDetail4PaPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class InspectTaskDetail4PaTask extends ExportTask {
	...
	public void execute() {
		...
		//设置导出策略
		Policy policy = new InspectTaskDetail4PaPolicy(this);
		//设置导出writer

...
import cn.com.flaginfo.platform.export.model.excel.policy.InspectInvokeHourPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class InspectInvokeHourTask extends ExportTask {
	...
	public void execute() {
		...
		//设置导出策略
		Policy policy = new InspectInvokeHourPolicy(this);
		//设置导出writer

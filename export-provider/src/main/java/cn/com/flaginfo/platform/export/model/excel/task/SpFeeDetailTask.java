...
import cn.com.flaginfo.platform.export.model.excel.policy.SpFeeDetailPolicy;

public class SpFeeDetailTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SpFeeDetailPolicy(this);
		//设置导出writer

...
import cn.com.flaginfo.platform.export.model.excel.policy.PlatformFinanceBillPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class PlatformFinanceBillTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new PlatformFinanceBillPolicy(this);
		//设置导出writer

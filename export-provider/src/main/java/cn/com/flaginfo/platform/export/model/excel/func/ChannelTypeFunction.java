 ...
 * 2016年8月16日
 */
public class ChannelTypeFunction implements Function<Object, Object>{

    @Override
    public String apply(Object value, Object param) {
        if(Constants.CHANNEL_TYPE_THREE.equals(value)){
            return "三要素验真";
        }
        if(Constants.CHANNEL_TYPE_TWO.equals(value)){
            return "二要素验真";
        }
        return "-";
    }

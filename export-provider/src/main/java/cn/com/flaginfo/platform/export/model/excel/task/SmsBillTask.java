...
import cn.com.flaginfo.platform.export.model.excel.policy.SmsBillPolicy;

public class SmsBillTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SmsBillPolicy(this);
		//设置导出writer

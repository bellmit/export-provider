...
import cn.com.flaginfo.platform.export.model.excel.policy.PlatformIncomeDetailPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class PlatformIncomeDetailTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		Policy policy = new PlatformIncomeDetailPolicy(this);

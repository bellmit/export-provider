...
import cn.com.flaginfo.platform.export.model.excel.policy.SpCountryIntlPricePolicy;

public class SpCountryIntlPriceTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SpCountryIntlPricePolicy(this);
		//设置导出writer

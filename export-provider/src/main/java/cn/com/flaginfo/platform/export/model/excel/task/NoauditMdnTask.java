...
import cn.com.flaginfo.platform.export.model.excel.policy.NoauditMdnPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class NoauditMdnTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new NoauditMdnPolicy(this);
		//设置导出writer

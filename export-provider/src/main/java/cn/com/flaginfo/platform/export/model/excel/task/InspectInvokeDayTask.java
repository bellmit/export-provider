...
import cn.com.flaginfo.platform.export.model.excel.policy.InspectInvokeDayPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class InspectInvokeDayTask extends ExportTask {
	...
	public void execute() {
		...
		//设置导出策略
		Policy policy = new InspectInvokeDayPolicy(this);
		//设置导出writer

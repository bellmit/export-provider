...
public class PlatformSmsBillPolicy extends Policy {
	...
	public PlatformSmsBillPolicy (ExportTask task){
		this.task = task;
		initPolicy();
	}
	...
	public void initPolicy() {
		this.setApiUrl("billing_platform_sms_bill");
		this.setApiVersion("1.0");
		titles = new String[]{ "省份", "套餐费", "超套餐费","消费金额合计", "套内调账","超套调账",
		...
		keys = new String[]{ "platform", "packageFee", "outPackageFee", "totalFee","packageFeeAddition","outPackageFeeAddtion",
		...
		this.setFilePath(getUnitPath("PlatformSmsBill"));
	}
	...
	public Map<String, Object> getInfo(Map<String, Object> pageInfo) {
		...
		Map<String, Object> response = billApi.platformSmsBill(JsonHelper.parseToJson(requestParams));
		return response;
	}
}

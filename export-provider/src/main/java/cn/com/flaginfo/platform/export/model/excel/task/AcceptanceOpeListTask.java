...
import cn.com.flaginfo.platform.export.model.excel.policy.AcceptanceOpeListPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class AcceptanceOpeListTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new AcceptanceOpeListPolicy(this);
		//设置导出writer

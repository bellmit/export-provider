...
import cn.com.flaginfo.platform.export.model.excel.policy.BillAccountListPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class BillAccountListTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new BillAccountListPolicy(this);
		//设置导出writer

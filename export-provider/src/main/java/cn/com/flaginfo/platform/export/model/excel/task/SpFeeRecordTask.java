...
import cn.com.flaginfo.platform.export.model.excel.policy.SpFeeRecordPolicy;

public class SpFeeRecordTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SpFeeRecordPolicy(this);
		//设置导出writer

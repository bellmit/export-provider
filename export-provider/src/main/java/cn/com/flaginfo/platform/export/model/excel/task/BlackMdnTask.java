...
import cn.com.flaginfo.platform.export.model.excel.policy.BlackMdnPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class BlackMdnTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new BlackMdnPolicy(this);
		//设置导出writer

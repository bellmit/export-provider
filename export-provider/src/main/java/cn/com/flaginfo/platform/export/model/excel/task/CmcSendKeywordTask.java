...
import cn.com.flaginfo.platform.export.model.excel.policy.CmcSendKeywordPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class CmcSendKeywordTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new CmcSendKeywordPolicy(this);
		//设置导出writer

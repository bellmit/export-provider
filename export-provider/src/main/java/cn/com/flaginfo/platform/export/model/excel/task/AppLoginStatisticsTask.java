...
import cn.com.flaginfo.platform.export.model.excel.policy.AppLoginStatisticsPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class AppLoginStatisticsTask extends ExportTask {

    @Override
    public void execute() {
        ExportResult result = new ExportResult();
        //设置导出策略
        Policy policy = new AppLoginStatisticsPolicy(this);
        //设置导出writer

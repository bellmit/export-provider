...
import cn.com.flaginfo.platform.export.model.excel.policy.SpFinanceBillPolicy;

public class SpFinanceBillTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SpFinanceBillPolicy(this);
		//设置导出writer

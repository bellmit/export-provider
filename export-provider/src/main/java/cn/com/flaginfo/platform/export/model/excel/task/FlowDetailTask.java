...
import cn.com.flaginfo.platform.export.model.excel.policy.FlowDetailPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class FlowDetailTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new FlowDetailPolicy(this);
		//设置导出writer

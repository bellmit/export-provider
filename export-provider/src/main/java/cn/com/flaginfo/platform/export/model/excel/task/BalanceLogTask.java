...
import cn.com.flaginfo.platform.export.model.excel.policy.BalanceLogPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class BalanceLogTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new BalanceLogPolicy(this);
		//设置导出writer

...
import cn.com.flaginfo.platform.export.model.excel.policy.BusiAdjustRecordPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class BusiAdjustRecordTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new BusiAdjustRecordPolicy(this);
		//设置导出writer

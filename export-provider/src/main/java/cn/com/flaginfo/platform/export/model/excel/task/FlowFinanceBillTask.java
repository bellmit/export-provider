...
import cn.com.flaginfo.platform.export.model.excel.policy.FlowFinanceBillPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class FlowFinanceBillTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new FlowFinanceBillPolicy(this);
		//设置导出writer

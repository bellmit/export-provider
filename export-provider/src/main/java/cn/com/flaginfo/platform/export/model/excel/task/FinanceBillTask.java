...
import cn.com.flaginfo.platform.export.model.excel.policy.FinanceBillPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class FinanceBillTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new FinanceBillPolicy(this);
		//设置导出writer

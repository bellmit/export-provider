...
import cn.com.flaginfo.platform.export.model.excel.policy.SubscribeEffectRecordPolicy;

public class SubscribeEffectRecordTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SubscribeEffectRecordPolicy(this);
		//设置导出writer

...
import cn.com.flaginfo.platform.export.model.excel.policy.PlatformSmsBillPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class PlatformSmsBillTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		// 设置导出策略
		Policy policy = new PlatformSmsBillPolicy(this);
		// 设置导出writer

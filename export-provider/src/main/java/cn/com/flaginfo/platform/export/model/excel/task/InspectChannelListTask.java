...
import cn.com.flaginfo.platform.export.model.excel.policy.InspectChannelListPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class InspectChannelListTask extends ExportTask {
	...
	public void execute() {
		...
		//设置导出策略
		Policy policy = new InspectChannelListPolicy(this);
		//设置导出writer

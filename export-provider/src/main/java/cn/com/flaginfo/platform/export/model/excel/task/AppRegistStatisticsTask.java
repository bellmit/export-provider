...
import cn.com.flaginfo.platform.export.model.excel.policy.AppRegistStatisticsPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class AppRegistStatisticsTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new AppRegistStatisticsPolicy(this);
		//设置导出writer

...
public class GoodsBuyRecordDetailPolicy extends Policy {
	...
	public GoodsBuyRecordDetailPolicy (ExportTask task){
		this.task = task;
		initPolicy();
	}
	...
	public void initPolicy() {
		...
		titles = new String[]{ "购买流水号","企业编号", "企业名称","省份","地市","商品类型", "购买费用(元)","优惠后费用(元)","数量","实际计费金额","购买时间"};
		keys = new String[]{ "id","spCode", "spName","platform","city","goodsType", "fee","realFee","quantity","deductFee","createTime"};

...
import cn.com.flaginfo.platform.export.model.excel.policy.IntlSendObjectPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class IntlSendObjectTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new IntlSendObjectPolicy(this);
		//设置导出writer

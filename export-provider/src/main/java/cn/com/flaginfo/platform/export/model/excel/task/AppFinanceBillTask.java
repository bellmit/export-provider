...
import cn.com.flaginfo.platform.export.model.excel.policy.AppFinanceBillPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class AppFinanceBillTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new AppFinanceBillPolicy(this);
		//设置导出writer

...
import cn.com.flaginfo.platform.export.model.excel.policy.PlatformWeeklyIncomePolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class PlatformWeeklyIncomeTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new PlatformWeeklyIncomePolicy(this);
		//设置导出writer

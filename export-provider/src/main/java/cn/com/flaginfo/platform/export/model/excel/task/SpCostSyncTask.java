...
import cn.com.flaginfo.platform.export.model.excel.policy.SpCostSyncPolicy;

public class SpCostSyncTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SpCostSyncPolicy(this);
		//设置导出writer

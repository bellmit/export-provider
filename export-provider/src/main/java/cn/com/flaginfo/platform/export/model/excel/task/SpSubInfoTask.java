...
import cn.com.flaginfo.platform.export.model.excel.policy.SpSubInfoPolicy;

public class SpSubInfoTask extends ExportTask {
	...
	public void execute() {
		...
		//设置导出策略
		Policy policy = new SpSubInfoPolicy(this);
		//设置导出writer

...
import cn.com.flaginfo.platform.export.model.excel.policy.IotCardExportPolicy;
import cn.com.flaginfo.platform.export.model.excel.policy.Policy;

public class IotCardExportTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new IotCardExportPolicy(this);
		//设置导出writer

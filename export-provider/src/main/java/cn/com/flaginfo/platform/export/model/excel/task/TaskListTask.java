...
import cn.com.flaginfo.platform.export.model.excel.policy.TaskListPolicy;

public class TaskListTask extends ExportTask {
	...
	public void execute() {
		...
		//设置导出策略
		Policy policy = new TaskListPolicy(this);
		//设置导出writer

...
import cn.com.flaginfo.platform.export.model.excel.policy.SmsAdjustRecordPolicy;

public class SmsAdjustRecordTask extends ExportTask{

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SmsAdjustRecordPolicy(this);
		//设置导出writer

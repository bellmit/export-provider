...
import cn.com.flaginfo.platform.export.model.excel.policy.SpOrderListPolicy;

public class SpOrderListTask extends ExportTask {

	@Override
	public void execute() {
		ExportResult result = new ExportResult();
		//设置导出策略
		Policy policy = new SpOrderListPolicy(this);
		//设置导出writer
